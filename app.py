...
# Loading the Profiles w/o cluster designations
with open("refined_profiles.pkl",'rb') as fp:
    df = pickle.load(fp)

# Loading the profiles with cluster designations    
with open("refined_cluster.pkl", 'rb') as fp:
    cluster_df = pickle.load(fp)

# Loading the vectorized profiles    
...
image = Image.open('download (5).jpeg')
